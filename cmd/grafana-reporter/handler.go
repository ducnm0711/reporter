...
import (
	...
	"github.com/ducnm0711/reporter/grafana"
	"github.com/ducnm0711/reporter/report"
...
func RegisterHandlers(router *mux.Router, reportServerV4, reportServerV5 ServeReportHandler) {
	...
	router.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
		fmt.Fprintf(w, "This is grafana-reporter. \nThe API endpoints are documented here: https://github.com/ducnm0711/reporter#endpoint.")
	})
